...
public class Rule2060604862 extends PairTupleRule {
    protected List<Column> leftHandSide = new ArrayList();
    protected List<Column> rightHandSide = new ArrayList();

    public Rule2060604862() {}

    @Override
    public void initialize(String id, List<String> tableNames) {
        super.initialize(id, tableNames);
        leftHandSide.add(new Column("TB_NADEEF_TEMP_DATASET.url")); 
        leftHandSide.add(new Column("TB_NADEEF_TEMP_DATASET.title")); 

        rightHandSide.add(new Column("TB_NADEEF_TEMP_DATASET.model")); 
